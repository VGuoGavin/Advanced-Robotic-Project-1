...
run('/Users/shipingguo/Downloads/ur5_modeling_force_estimate-master/Derive_Dyn_Equations_Model_C/Geometrical_Jacobian.m')
...
% Center of mass vectors (in [m]), in body frame
r1_c1 = [0,         -25.61,     1.93]       *0.001;
r2_c2 = [212.5,     0,          113.36]     *0.001;
r3_c3 = [119.93,    0,          26.5]       *0.001;
r4_c4 = [0,         -1.8,       16.34]      *0.001;
r5_c5 = [0,         1.8,        16.34]      *0.001;
r6_c6 = [0,         0,          -1.159]     *0.001;
...
[I_1, I_2, I_3, I_4, I_5, I_6] = Get_Inertia_Matrices()
...
D_1(theta_1, theta_2, theta_3, theta_4, theta_5, theta_6) = ...
    ...
    transpose(Jc1_angular)*R1(theta_1)*I_1*transpose(R1(theta_1))*Jc1_angular;

D_2(theta_1, theta_2, theta_3, theta_4, theta_5, theta_6) = ...
    m_2*transpose(Jc2_linear)*Jc2_linear + ...
    transpose(Jc2_angular)*R2(theta_1, theta_2)*I_2*transpose(R2(theta_1, theta_2))*Jc2_angular;
...
D_3(theta_1, theta_2, theta_3, theta_4, theta_5, theta_6) = ...
    ...
    I_3*transpose(R3(theta_1, theta_2, theta_3) )*Jc3_angular;
...
D_4(theta_1, theta_2, theta_3, theta_4, theta_5, theta_6) = ...
    ...
    I_4*transpose(R4(theta_1, theta_2, theta_3, theta_4))*Jc4_angular;

D_5(theta_1, theta_2, theta_3, theta_4, theta_5, theta_6) = ...
    m_5*transpose(Jc5_linear)*Jc5_linear + ...
    transpose(Jc5_angular)*R5(theta_1, theta_2, theta_3, theta_4, theta_5)*I_5...
...
D_6(theta_1, theta_2, theta_3, theta_4, theta_5, theta_6) = ...
    ...
    transpose(Jc6_angular)*R6(theta_1, theta_2, theta_3, theta_4, theta_5, theta_6)*I_6...
